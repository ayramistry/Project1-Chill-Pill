              ...
              return Stack(
                children: [
                  Positioned(
                    ...
                    left: 50,
                    child: _buildCircle(45, Colors.purple.shade100.withOpacity(0.3)),
                  ),
                  Positioned(
                    top: 230 - _float2.value,
                    right: 40,
                    child: _buildCircle(60, Colors.purple.shade200.withOpacity(0.3)),
                  ),
                  Positioned(
                  ...
                  Positioned(
                    ...
                    left: 90,
                    child: _buildCircle(15, Colors.purple.shade100.withOpacity(0.25)),
                  ),
                  Positioned(
                    top: 260 + _float2.value / 3,
                    right: 90,
                    child: _buildCircle(10, Colors.purple.shade200.withOpacity(0.2)),
                  ),
                  Positioned(
                  ...
                  Positioned(
                    ...
                    right: 130,
                    child: _buildCircle(14, Colors.purple.shade100.withOpacity(0.2)),
                  ),
                ],
              );
            },
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      Navigator.of(context).push(WavePageRoute(page: const NextScreen()));
                    },
...
class TransitionWaveClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    path.quadraticBezierTo(size.width / 4, controlY - waveHeight, size.width / 2, controlY);
    path.quadraticBezierTo(3 * size.width / 4, controlY + waveHeight, size.width, controlY);
